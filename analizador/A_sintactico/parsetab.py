...
_lr_productions = [
  ...
  ('programa -> declaraciones','programa',1,'p_programa','parser.py',9),
  ('declaraciones -> declaraciones declaracion SEMICOLON','declaraciones',3,'p_declaraciones','parser.py',14),
  ('declaraciones -> declaracion SEMICOLON','declaraciones',2,'p_declaraciones','parser.py',15),
  ('declaracion -> NODO LPAREN ID RPAREN','declaracion',4,'p_declaracion_nodo','parser.py',23),
  ('declaracion -> ELIMINAR_NODO LPAREN ID RPAREN','declaracion',4,'p_declaracion_eliminar_nodo','parser.py',27),
  ('declaracion -> ARISTA LPAREN ID COMMA ID RPAREN','declaracion',6,'p_declaracion_arista','parser.py',31),
  ('declaracion -> ARISTA LPAREN ID COMMA ID COMMA NO_D RPAREN','declaracion',8,'p_declaracion_arista','parser.py',32),
  ('declaracion -> ELIMINAR_ARISTA LPAREN ID COMMA ID RPAREN','declaracion',6,'p_declaracion_eliminar_arista','parser.py',39),
  ('declaracion -> PESO LPAREN ID COMMA ID COMMA NUMBER RPAREN','declaracion',8,'p_declaracion_peso','parser.py',43),
  ('declaracion -> RUTA_MINIMA LPAREN ID COMMA ID RPAREN','declaracion',6,'p_declaracion_ruta_minima','parser.py',47),
]
